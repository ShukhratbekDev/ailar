    ...
    try {
        ...
        const systemPrompt = `
            ...
            RESPONSE FORMAT:
            {
                ...
                "category": "Preferred: Chatbot, Video yaratish, Rasm yaratish, Unumdorlik, Matn yozish, Dasturlash, Marketing, Audio/Ovoz, SEO, Dizayn, Tadqiqot, Fan va Ta'lim, Biznes va Analitika. (If none fit, you can suggest a highly descriptive new category in Uzbek)",
